...
operation::query-events[snippets='request-parameters,curl-request,http-request,http-response,links,response-fields,http-response']
...
operation::get-an-event[snippets='path-parameters,curl-request,http-request,links,response-fields,http-response']
...
operation::update-event[snippets='path-parameters,curl-request,http-request,request-headers,request-fields,http-response,response-headers,response-fields,links']